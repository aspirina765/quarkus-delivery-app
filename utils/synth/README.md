...
```bash
synth import postgres --from postgres://cadastro:cadastro@localhost:5432/postgres
```
...
```bash
synth generate my_app --to postgres://cadastro:cadastro@localhost:5432/postgres
```

...
install_telemetry() {
  echo " ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
  echo "                                                                     "
  echo "  Hey wonderful new user!                                            "
  echo "                                                                     "
  echo "  Just to let you know, we collect anonymous usage data to help us   "
  echo "  make synth the best tool it can be for you. You can learn more     "
  echo "  about the data we collect and why we do it at                      "
  echo "                                                                     "
  echo "      https://getsynth.com/docs/other/telemetry                      "
  echo "                                                                     "
  echo "  If this is not OK, just run                                        "
  echo "                                                                     "
  echo "      synth telemetry disable                                        "
  echo "                                                                     "
  echo "  from a terminal.                                                   "
  echo "                                                                     "
  echo "  With <3, the Synth team.                                           "
  echo "                                                                     "
  echo " ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
